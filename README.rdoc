Hermes is my response to the changes that I expect to come with wearable technology over the next few years. I believe that the way we handle messaging today is not designed for an environment with several screens, nor does it properly take into account contextual information when deciding when and how to present messages.
